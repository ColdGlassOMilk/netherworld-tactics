...
function bindings:bind_action_menu()
  input:bind({
    [2] = function()
      if game.action_menu then game.action_menu:nav(-1) end
    end,
    [3] = function()
      if game.action_menu then game.action_menu:nav(1) end
    end,
    ...
    [5] = function()
      if game.action_menu then game.action_menu:select() end
    end
  })
end
...
function bindings:bind_deploy_menu()
  input:bind({
    [2] = function()
      if game.deploy_menu then game.deploy_menu:nav(-1) end
    end,
    [3] = function()
      if game.deploy_menu then game.deploy_menu:nav(1) end
    end,
    ...
    [5] = function()
      if game.deploy_menu then game.deploy_menu:select() end
    end
  })
end
...
function bindings:bind_options_menu()
  input:bind({
    ...
    [4] = function()
      if game.options_menu then
        game.options_menu:hide()
      end
